...
import StackAsArray from "../src/Data Structures/Linear Structures/StackAsArray.js";
...
describe('Stacks', () => {
  describe('Stack', () => {
    it('Should push and pop correctly', () => {
      ...
      expect(stack.pop() === "hello3").to.be.true;
  ...
  describe('StackAsArray', () => {
    it('Should push and pop correctly', () => {
      var stack = new StackAsArray();
      stack.push("hello1");
      stack.push("hello2");
      stack.push("hello3");
